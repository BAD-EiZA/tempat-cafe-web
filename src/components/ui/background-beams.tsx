  ...
  return (
    ...
    >
      ...
      {[...Array(6)].map((_, i) => (
        <div
          key={i}
          className="animate-beam absolute w-px bg-gradient-to-b from-transparent via-cafe-forest-mid/50 to-transparent"
          style={{
            left: `${12 + i * 15}%`,
            height: '40%',
  ...
  return (
    ...
    >
      ...
      {[...Array(5)].map((_, i) => (
        <div
          key={i}
          className="animate-beam absolute w-px bg-gradient-to-b from-transparent via-cafe-accent/40 to-transparent"
          style={{
            left: `${18 + i * 16}%`,
            height: '50%',
